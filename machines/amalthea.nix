    ...
    services = {
      golink = {
        ...
        serviceConfig = {
          ...
          # The tsnet identity provides per-user ownership; clients use http://go/.
          ExecStart = "${golinkPackage}/bin/golink -advertise-tags=tag:server -hostname=go -sqlitedb /var/lib/golink/golink.db";
          Restart = "on-failure";
          RestartSec = "10s";
